...
def initPanel(self):
    ...
    for item in textList:
        label = Label(text=item, size_hint=(1,1), markup=True, font_name="maintextfont", font_size=config.basefont80)
    ...
    button = Button(text="Hear a rumor", size_hint=(1,1), background_normal='', background_color=neutral, background_down='', background_color_down=neutral, font_name='maintextfont', font_size=config.basefont80)
    button.self = self
    ...
    button = Button(text="List of Scenes", size_hint=(1,1), background_normal='', background_color=neutral, background_down='', background_color_down=neutral, font_name="maintextfont", font_size=config.basefont80)
    button.self = self
    button.bind(on_press=self.pressGenericButton)
    button.bind(on_release=listScenes)
    self.decreeMainBox.add_widget(button)

    button = Button(text="Safe Spot", size_hint=(1,1), background_normal='', background_color=neutral, background_down='', background_color_down=neutral, font_name="maintextfont", font_size=config.basefont80)
    button.self = self
    button.bind(on_press=self.pressGenericButton)
