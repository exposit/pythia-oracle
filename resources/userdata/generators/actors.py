...
def initPanel(self):
    ...
    actorsAItem = AccordionItem(title='Actors', background_selected='invisible.png', min_space=30)
...
def actorAppearanceModifier():
    ...
    modifier = random.choice(["True gender is opposite apparent gender.", "True gender is hard to determine.", "True age is younger than appears.", "True age is older than appears.", "In disguise.", "Wealthier than appears.", "Poorer than appears.", "Is not what they seem.", "Is exactly what they seem.", "Is impersonating someone else.", "Is more in some way than they appear.", "Is less in some way than they appear."])
...
def actorVisibleQuirk():
    ...
    "thin", "extremely average; they must work at it", "limping", "distinctive facial feature", "many hair braids", "very pale","smells like alcohol or drugs", "smells nice", "smells bad", "black eye", "light freckles", "heavy freckles", "clumsy", "looks tired", "mole", "clothes don't fit well", "clothes very tailored", "graceful", "intense eyes", "distant stare", "prominent birthmark", "prominent scar", "disfiguring scar", "faint scar", "tanned", "broken limb", "bite or claw mark scar", "paint or dye on hands", "flower or leaves in hair", "rubbing back of neck", "military bearing", "displays a totem", "has a pet", "sunburned", "paragon of their race", "exemplar of their race", "minor tattoo", "many tattoos", "untreated battle wound", "inappropriate attire", "beautiful", "plain", "ugly", "mark of special heritage", "unnaturally beautiful", "unnaturally ugly", "incredibly charismatic", "appealing", "disturbing demeanor", "repellent", "immobilizing injury", "minor birthmark", "mark of unnatural heritage", "mark of distasteful heritage", "stocky and wide", "tall and slender", "petite and curvy", "waifish", "lithe and muscular", "distinctive jewelry", "distinctive weapon", "distinctive clothes", "wearing an item of military gear", "looks tired", "carrying a wounded pet", "carrying a child", "carrying a wounded ally", "carrying too little gear to be prepared for surroundings", "chewing on something", "barely remaining standing", "falls unconscious", "typical hair color for a group", "typical eye color for a group", "tall for gender", "short for gender", "robust for gender", "scrawny for gender", "well-endowed in secondary sexual characteristics", "lacking in secondary sexual characteristics", "very long hair", "very short hair", "definite case of bed-head", "sweating heavily", "cool as a cucumber", "shrewd, piercing gaze", "constantly assessing", "covered in tattoos",
    ]
...
def actorNonvisibleQuirk():
    ...
    chart = [
    "fond of rhetorical questions", "incorrigible gossip", "keeps secrets", "cusses like a sailor", "really bad cook", "really good cook", "taciturn", "gestures while talking", "overly physically friendly", "stutters", "falls in love easily", "accent", "very perceptive", "very unperceptive", "chip on shoulder", "placid temperament", "volatile temperament", "paranoid", "explosive temper", "hard to rouse to anger", "holds grudges", "lets bygones be bygones", "superstitious", "conceited", "nods frequently", "has a pet", "carries a totem", "pouty", "vicious", "mixes up two languages in speech", "has a soft spot for children", "has a soft spot for orphans", "can't stand small children", "hates a common pet type", "loves a common pet type", "stuck up", "down to earth", "wistful for the past", "apprehensive about the future", "afraid of change", "desperate for change", "pessimist", "optimist", "pauses frequently when speaking", "dry sense of humor", "slapstick sense of humor", "openly prejudiced", "rigorously prepared in area of expertise", "a very good friend", "values loyalty above all else", "values honor above all else", "values family above all else", "values self above all else", "emotionally damaged", "emotionally centered", "feels at peace", "feels guilty", "bad at small talk", "bad at flirtation", "bad at negotiation", "nervous when around object of attraction", "easily embarrassed", "has no shame", "easily distracted", "single-minded", "cannot read or write", "unfailingly polite", "extremely rude", "has a phobia", "extremely sophisticated", "jaded and cynical", "bad temper", "tends to negativity"
    ]
