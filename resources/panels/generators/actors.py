...
def actorVisibleQuirk():
    ...
    chart = [
    "gap in front teeth", "unusual eye color", "unusual hair color", "very tall", "very short", "plump or well-nourished", "thin or underfed", "extremely average; they must work at it", "limping", "distinctive facial feature", "many hair braids", "very pale","smells of alcohol, drugs, or another vice", "smells clean", "smells strongly", "black eye", "light freckles", "heavy freckles", "clumsy", "looks tired", "mole", "clothes don't fit well", "clothes very tailored", "graceful", "intense eyes", "distant stare", "prominent birthmark", "prominent scar", "disfiguring scar", "faint scar", "tanned", "broken limb", "bite or claw mark scar", "paint or dye on hands", "flower or leaves in hair", "rubbing back of neck", "military bearing", "openly displays a totem", "has a pet", "sunburned", "paragon of their race", "exemplar of their race", "minor tattoo or mark", "many tattoos or marks", "untreated wound", "inappropriate attire", "beautiful", "plain", "ugly", "mark of special heritage", "unnaturally beautiful", "unnaturally ugly", "incredibly charismatic", "appealing", "disturbing demeanor", "repellent", "immobilizing or slowing injury", "minor birthmark", "mark of unnatural heritage", "mark of distasteful heritage", "stocky", "tall", "short", "waifish", "lithe", "muscular", "wiry", "athletic", "distinctive jewelry", "distinctive weapon", "distinctive clothes", "wearing an item of military gear", "looks tired", "looks shocked", "looks surprised", "looks terrified", "carrying a wounded pet", "carrying a child", "carrying a wounded person", "carrying too little gear to be prepared for surroundings", "chewing on something", "barely remaining standing", "falling unconscious", "typical hair color for a group", "typical eye color for a group", "tall for gender", "short for gender", "robust for gender", "undersized for gender", "physically exceptional", "exceptional in an obvious way", "paragon of gender", "very long hair", "very short hair", "definite case of bed-head", "sweating heavily", "cool and collected", "shrewd or piercing gaze", "constantly assessing", "completely covered in tattoos or marks", "carrying a dangerous animal", "has sharpened teeth", "mutation or power", "royal bearing", "haughty or arrogant bearing", "delicate hands", "looking down", "scanning the area", "mark of exotic heritage", "heritage is hard to determine", "lingering injury or infirmity"
    ]
...
def actorRelationshipClose(npc1="The first actor", npc2="the second actor"):
    ...
    closeChart = [
       "was insulted and humiliated by", "wants to impress", "wants the approval of", "wants the love of", "wants the forgiveness of", "wants the understanding of", "wants the respect of", "opposes every goal of", "is married to or devoted to", "is close blood kin of", "is distant blood kin of", "hates but can't escape from", "is in love with", "is trying to ruin", "was childhood friends with", "grew up with", "was childhood rivals with", "came to blows with", "respects the opinion of", "disregards the value of", "finds everything objectionable about", "finds everything admirable about", "seeks out the advice of", "is a lover or friend of", "is married to or trapped by", "wants to free", "puts up with", "watches out for", "would be happier without", "would be much worse off without", "would be much worse off if not for", "would be richer if not for", "was saved from harm by", "was saved from dire peril by", "was saved from embarrassment or social ruin by", "took a blow for", "sacrificed for", "is loyal to", "is disloyal to", "is an ex of", "was close to but is now estranged from", "is resentful of", "is a crutch or linchpin for", "was uplifted because of", "would be less well-off if not for", "has a passion for", "despises", "appreciates", "is afraid of", "is afraid for"
    ]

    overtly = random.choice(["overtly", "covertly"])
    actively = random.choice(["actively", "passively"])

    result = npc1 + " " + random.choice(closeChart) + " " + npc2 + " and expresses this " + overtly + " and " + actively + "."
    return result

def actorRelationshipGroup(npc1="The first actor", group1="the target group"):

    groupChart = [
       "is a member in good standing of", "is an escapee from", "is a lapsed member of", "is an ardent supporter of", "is a fanatic of", "seeks to undermine", "seeks to join", "seeks to disband", "wants to avoid contact with", "wants to be left alone by", "wants the counsel of", "is hunted by", "pays lip service to", "tithes regularly to", "is oppressed by", "was liberated by", "believes in the cause of", "agrees with the philosphy but not the methods of", "agrees with the methods but not the motives of", "is being fooled by", "is a high-ranking member of", "has a relative who is a high-ranking member of", "has a relative they wish to free from", "swore an oath to", "owes a great debt to", "is trapped by", "was aided by", "was rescued by"
    ]

    overtly = random.choice(["overtly", "covertly"])
    actively = random.choice(["actively", "passively"])

    result = npc1 + " " + random.choice(groupChart) + " " + group1 + " and expresses this " + overtly + " and " + actively + "."
    return result

def actorRelationshipGeneral(npc1="The actor", object="the target"):

    generalChart =[
    "is ashamed of", "hates and fears", "is enraged by", "is happy with", "is thrilled by", "wants to avoid", "prefers to deal with", "wants to destroy", "wants to preserve", "wants to fight", "wants to make peace with", "wants to use", "wants to prevent others from using", "wants to hide", "wants to reveal", "wants to own", "wants to get rid of", "needs but doesn't want", "wants but doesn't need", "cares about but fears", "sees only danger from", "sees safety in", "sees the potential of",
    ]
...
def dualMotives():
    ...
    goalChart = [ "to consume out of necessity", "to consume out of greed", "to trade gossip", "to protect home", "to make a new friend","to serve a master", "to preserve beauty", "to pass on a curse out of spite", "to maintain silence", "to consume endlessly", "to seduce to ruin", "to procreate", "to lure into a trap", "to make a living", "to find meaning in life", "to placate an object of worship", "to sacrifice suitable targets", "to stop the invaders", "to preserve life", "to hoard shiny things", "to pass on a curse and thus be rid of it", "to protect offspring", "to deceive for personal gain", "to deceive for the greater good", "to stop a greater evil", "to gain an edge over", "to avoid passing on a curse", "to watch over a ward", "to learn about the world", "to explore new places", "to fall in love", "to conquer", "to ensnare", "to see the world burn", "to find excitement", "to stir up mischief", "to gain resources for the tribe", "to get revenge for a petty slight", "to get revenge for a serious matter", "to test someone's mettle", "to test the limits of skill", "to create something of lasting value", "to perfect a physical being", "to secure their safety", "to experience the thrill of the forbidden", "to seduce for pleasure", "to seduce for nefarious purposes", "to be entertained", "to be flattered and praised", "to seduce to a cause or mission or betrayal", "to seduce away from a cause or mission", "to seduce out of duty", "to increase food stores against hardship", "to increase weapons", "to find a companion", "to find a cause", "to be the best at something", "to gain ridiculous levels of wealth", "to obtain someone else's loved one", "to love 'em and leave 'em", "to cuckold or embarrass a rival", "to be a hero", "to scout out opportunities", "to find the truth", "to find true love", "to destroy out of necessity", "to bully the weak", "to live like a tyrant", "to live like a king", "to taste a delicacy", "to perform a great deed", "to perform a masterwork", "to escape a prison", "to imprison someone", "to enjoy solitude", "to avoid others", "to learn how to socialize", "to learn a secret", "to perform an appointed duty", "to subvert an appointed duty", "to shirk a duty", "to feel alive", "to ruin someone more powerful", "to murder", "to steal from by stealth or trickery", "to take from by force or guile", "to discredit", "to break free from", "to destroy out of malice", "to overthrow a ruler", "to repair a great wrong", "to make things right", "to create something creative", "to rebuild that which is destroyed", "to mend that which is broken", "to have a polite chat", "to learn news of the outside world", "to acquire something simply to have it", "to have an intelligent conversation", "to earn freedom", "to enslave as labor or cannon fodder", "to get to the other side", "to acquire magic for magic's sake", "to solve a puzzle or anomaly", "to experience other ways of life", "to entice to a dangerous task", "to embark on a perilous journey", "to get someone else to assume the risk", "to encourage bravery", "to encourage cowardice", "to encourage love", "to encourage lust", "to scare off interlopers", "to acquire knowledge for knowledge's sake", "to trap interlopers to meet basic needs", "to trade for treasure", "to trade for exotic wares", "to sell fruits of someone else's labors", "to help someone else" "to sell someone else", "to buy someone else", "to prove worthy of an honor", "to find a way in", "to find a way out", "to achieve success", "to atone for a sin of omission", "to achieve power peacefully and rightfully", "to achieve power through force and guile", "to atone for a transgression", "to locate the missing", "to buy just a little more time", "to indulge an addiction or craving", "to transmit a disease, contagion, or state of being", "to achieve status", "to retrieve a mark of status", "to express the pinnacle of an art", "to improve beauty", "to capture beauty", "to find literal immortality", "to find figurative immortality", "to be youthful", "to be wise", "to create more", "to destroy someone's creations", "to undo a terrible mistake", "to find a great treasure", "to prove the ends justify the means", "to have a civilized conversation", "to be tutored in the ways of another culture", "to bestow a boon", "to bestow a curse", "to be followed somewhere", "to spite someone", "to be free of a curse", "to keep it safe", "to keep it hidden",
    ]
...
adjectiveList = ["abandoned", "able", "absolute", "adorable", "adventurous", "academic", "acceptable", "acclaimed", "accomplished", "accurate", "aching", "acidic", "acrobatic", "active", "adept", "admirable", "admired", "adolescent", "adorable", "adored", "advanced", "afraid", "affectionate", "aggravating", "aggressive", "agile", "agitated", "agonizing", "agreeable", "alarmed", "alarming", "alert", "alienated", "alive", "altruistic", "amazing", "ambitious", "amused", "amusing", "anchored", "ancient", "angelic", "angry", "anguished", "animated", "annual", "antique", "anxious", "apprehensive", "appropriate", "apt", "arctic", "arid", "aromatic", "artistic", "ashamed", "assured", "astonishing", "athletic", "attached", "attentive", "attractive", "austere", "authentic", "authorized", "automatic", "avaricious", "average", "aware", "awesome", "awful", "awkward", "babyish", "bad", "back", "bare", "barren", "basic", "beautiful", "belated", "beloved", "beneficial", "better", "best", "bewitched", "big", "big-hearted", "bitter", "black-and-white", "bland", "blank", "blaring", "bleak", "blind", "blissful", "blushing", "boiling", "bold", "bony", "boring", "bossy", "bouncy", "bountiful", "bowed", "brave", "breakable", "brief", "bright", "brilliant", "brisk", "broken", "bruised", "bubbly", "bulky", "bumpy", "buoyant", "burdensome", "burly", "bustling", "busy", "buzzing", "calculating", "calm", "candid", "canine", "capital", "carefree", "careful", "careless", "caring", "cautious", "celebrated", "charming", "cheap", "cheerful", "cheery", "chief", "chilly", "chubby", "classic", "clean", "clear", "clear-cut", "clever", "closed", "clueless", "clumsy", "cluttered", "coarse", "cold", "colorful", "colorless", "colossal", "comfortable", "common", "compassionate", "competent", "complete", "complex", "complicated", "composed", "concerned", "concrete", "confused", "conscious", "considerate", "constant", "content", "conventional", "cooked", "cool", "cooperative", "coordinated", "corny", "corrupt", "costly", "courageous", "courteous", "crafty", "crazy", "creative", "creepy", "criminal", "crisp", "critical", "crooked", "crowded", "cruel", "crushing", "cuddly", "cultivated", "cultured", "cumbersome", "curly", "curvy", "cute", "damaged", "dangerous", "dapper", "daring", "darling", "dark", "dazzling", "dead", "deadly", "deafening", "decent", "decisive", "deep", "defenseless", "defensive", "defiant", "deficient", "definite", "definitive", "delayed", "delectable", "delicious", "delightful", "delirious", "demanding", "dense", "dependable", "dependent", "deserted", "detailed", "determined", "devoted", "different", "difficult", "diligent", "dim", "dimpled", "dimwitted", "direct", "disastrous", "discrete", "disfigured", "disgusting", "disloyal", "dismal", "distant", "dreary", "dirty", "disguised", "dishonest", "dismal", "distant", "distinct", "distorted", "dizzy", "dopey", "doting", "drab", "drafty", "dramatic", "dreary", "droopy", "dry", "dual", "dull", "dutiful", "eager", "earnest", "early", "easy", "easy-going", "ecstatic", "edible", "educated", "elaborate", "elastic", "elated", "electric", "elegant", "elementary", "elliptical", "embarrassed", "embellished", "eminent", "emotional", "empty", "enchanted", "enchanting", "energetic", "enlightened", "enormous", "enraged", "envious", "equal", "essential", "esteemed", "ethical", "euphoric", "even", "evergreen", "everlasting", "every", "evil", "exalted", "excellent", "exemplary", "exhausted", "excitable", "excited", "exciting", "exotic", "expensive", "experienced", "expert", "extraneous", "extroverted", "extra-large", "extra-small", "fabulous", "failing", "faint", "fair", "faithful", "fake", "false", "familiar", "famous", "fancy", "fantastic", "far", "faraway", "far-flung", "far-off", "fast", "fat", "fatal", "fatherly", "favorable", "favorite", "fearful", "fearless", "feisty", "feline", "female", "feminine", "few", "fickle", "filthy", "fine", "finished", "firm", "first", "firsthand", "fitting", "fixed", "flaky", "flamboyant", "flashy", "flat", "flawed", "flawless", "flickering", "flimsy", "flippant", "flowery", "fluffy", "fluid", "flustered", "focused", "fond", "foolhardy", "foolish", "forceful", "forked", "formal", "forsaken", "forthright", "fortunate", "fragrant", "frail", "frank", "frayed", "free", "French", "fresh", "frequent", "friendly", "frightened", "frightening", "frigid", "frilly", "frivolous", "front", "frosty", "frozen", "frugal", "fruitful", "full", "fumbling", "functional", "funny", "fussy", "fuzzy", "gargantuan", "gaseous", "general", "generous", "gentle", "genuine", "giant", "giddy", "gigantic", "gifted", "giving", "glamorous", "glaring", "glass", "gleaming", "gleeful", "glistening", "glittering", "gloomy", "glorious", "glossy", "glum", "golden", "good", "good-natured", "gorgeous", "graceful", "gracious", "grand", "grandiose", "granular", "grateful", "grave", "gray", "great", "greedy", "green", "gregarious", "grim", "grimy", "gripping", "grizzled", "gross", "grotesque", "grouchy", "grounded", "growing", "growling", "grown", "grubby", "gruesome", "grumpy", "guilty", "gullible", "gummy", "hairy", "half", "handmade", "handsome", "handy", "happy", "happy-go-lucky", "hard", "hard-to-find", "harmful", "harmless", "harmonious", "harsh", "hasty", "hateful", "haunting", "healthy", "heartfelt", "hearty", "heavenly", "heavy", "hefty", "helpful", "helpless", "hidden", "hideous", "high", "high-level", "hilarious", "hoarse", "hollow", "homely", "honest", "honorable", "honored", "hopeful", "horrible", "hospitable", "hot", "huge", "humble", "humiliating", "humming", "humongous", "hungry", "hurtful", "husky", "icky", "icy", "ideal", "idealistic", "identical", "idle", "idiotic", "idolized", "ignorant", "ill", "illegal", "ill-fated", "ill-informed", "illiterate", "illustrious", "imaginary", "imaginative", "immaculate", "immaterial", "immediate", "immense", "impassioned", "impeccable", "impartial", "imperfect", "imperturbable", "impish", "impolite", "important", "impossible", "impractical", "impressionable", "impressive", "improbable", "impure", "inborn", "incomparable", "incompatible", "incomplete", "inconsequential", "incredible", "indelible", "inexperienced", "indolent", "infamous", "infantile", "infatuated", "inferior", "infinite", "informal", "innocent", "insecure", "insidious", "insignificant", "insistent", "instructive", "insubstantial", "intelligent", "intent", "intentional", "interesting", "internal", "international", "intrepid", "ironclad", "irresponsible", "irritating", "itchy", "jaded", "jagged", "jam-packed", "jaunty", "jealous", "jittery", "joint", "jolly", "jovial", "joyful", "joyous", "jubilant", "judicious", "juicy", "jumbo", "junior", "jumpy", "juvenile", "keen", "key", "kind", "kindhearted", "kindly", "klutzy", "knobby", "knotty", "knowledgeable", "knowing", "known", "kooky", "kosher", "lame", "lanky", "large", "last", "lasting", "late", "lavish", "lawful", "lazy", "leading", "lean", "leafy", "left", "legal", "legitimate", "light", "lighthearted", "likable", "likely", "limited", "limp", "limping", "linear", "lined", "liquid", "little", "live", "lively", "livid", "loathsome", "lone", "lonely", "long", "long-term", "loose", "lopsided", "lost", "loud", "lovable", "lovely", "loving", "low", "loyal", "lucky", "lumbering", "luminous", "lumpy", "lustrous", "luxurious", "mad", "made-up", "magnificent", "majestic", "major", "male", "mammoth", "married", "marvelous", "masculine", "massive", "mature", "meager", "mealy", "mean", "measly", "meaty", "medical", "mediocre", "medium", "meek", "mellow", "melodic", "memorable", "menacing", "merry", "messy", "metallic", "mild", "mindless", "miniature", "minor", "minty", "miserable", "miserly", "misguided", "misty", "mixed", "modern", "modest", "moist", "monstrous", "monthly", "monumental", "moral", "mortified", "motherly", "motionless", "mountainous", "muddy", "muffled", "multicolored", "mundane", "murky", "mushy", "musty", "muted", "mysterious", "naive", "narrow", "nasty", "natural", "naughty", "nautical", "near", "neat", "necessary", "needy", "negative", "neglected", "negligible", "neighboring", "nervous", "new", "next", "nice", "nifty", "nimble", "nippy", "nocturnal", "noisy", "nonstop", "normal", "notable", "noted", "noteworthy", "novel", "noxious", "numb", "nutritious", "nutty", "obedient", "obese", "oblong", "oily", "oblong", "obvious", "occasional", "odd", "oddball", "offbeat", "offensive", "official", "old", "old-fashioned", "only", "open", "optimal", "optimistic", "opulent", "orange", "orderly", "organic", "ornate", "ornery", "ordinary", "original", "other", "outlying", "outgoing", "outlandish", "outrageous", "outstanding", "oval", "overcooked", "overdue", "overjoyed", "overlooked", "palatable", "pale", "paltry", "parallel", "parched", "partial", "passionate", "past", "pastel", "peaceful", "peppery", "perfect", "perfumed", "periodic", "perky", "personal", "pertinent", "pesky", "pessimistic", "petty", "phony", "physical", "piercing", "pink", "pitiful", "plain", "plaintive", "plastic", "playful", "pleasant", "pleased", "pleasing", "plump", "plush", "polished", "polite", "political", "pointed", "pointless", "poised", "poor", "popular", "portly", "posh", "positive", "possible", "potable", "powerful", "powerless", "practical", "precious", "present", "prestigious", "pretty", "precious", "previous", "pricey", "prickly", "primary", "prime", "pristine", "private", "prize", "probable", "productive", "profitable", "profuse", "proper", "proud", "prudent", "prudish", "punctual", "pungent", "puny", "pure", "purple", "pushy", "putrid", "puzzled", "puzzling", "quaint", "qualified", "quarrelsome", "quarterly", "queasy", "querulous", "questionable", "quick", "quick-witted", "quiet", "quintessential", "quirky", "quixotic", "quizzical", "radiant", "ragged", "rapid", "rare", "rash", "raw", "recent", "reckless", "rectangular", "ready", "real", "realistic", "reasonable", "red", "reflecting", "regal", "regular", "reliable", "relieved", "remarkable", "remorseful", "remote", "repentant", "required", "respectful", "responsible", "repulsive", "revolving", "rewarding", "rich", "rigid", "right", "ringed", "ripe", "roasted", "robust", "rosy", "rotating", "rotten", "rough", "round", "rowdy", "royal", "rubbery", "rundown", "ruddy", "rude", "runny", "rural", "rusty", "sad", "safe", "salty", "same", "sandy", "sane", "sarcastic", "sardonic", "satisfied", "scaly", "scarce", "scared", "scary", "scented", "scholarly", "scientific", "scornful", "scratchy", "scrawny", "second", "secondary", "second-hand", "secret", "self-assured", "self-reliant", "selfish", "sentimental", "separate", "serene", "serious", "serpentine", "several", "severe", "shabby", "shadowy", "shady", "shallow", "shameful", "shameless", "sharp", "shimmering", "shiny", "shocked", "shocking", "shoddy", "short", "short-term", "showy", "shrill", "shy", "sick", "silent", "silky", "silly", "silver", "similar", "simple", "simplistic", "sinful", "single", "sizzling", "skeletal", "skinny", "sleepy", "slight", "slim", "slimy", "slippery", "slow", "slushy", "small", "smart", "smoggy", "smooth", "smug", "snappy", "snarling", "sneaky", "sniveling", "snoopy", "sociable", "soft", "soggy", "solid", "somber", "some", "spherical", "sophisticated", "sore", "sorrowful", "soulful", "soupy", "sour", "sparkling", "sparse", "specific", "spectacular", "speedy", "spicy", "spiffy", "spirited", "spiteful", "splendid", "spotless", "spotted", "spry", "square", "squeaky", "squiggly", "stable", "staid", "stained", "stale", "standard", "starchy", "stark", "starry", "steep", "sticky", "stiff", "stimulating", "stingy", "stormy", "straight", "strange", "steelly", "strict", "strident", "striking", "striped", "strong", "studious", "stunning", "stupendous", "stupid", "sturdy", "stylish", "subdued", "submissive", "substantial", "subtle", "suburban", "sudden", "sugary", "sunny", "super", "superb", "superficial", "superior", "supportive", "sure-footed", "surprised", "suspicious", "svelte", "sweaty", "sweet", "sweltering", "swift", "sympathetic", "tall", "talkative", "tame", "tan", "tangible", "tart", "tasty", "tattered", "taut", "tedious", "teeming", "tempting", "tender", "tense", "tepid", "terrible", "terrific", "testy", "thankful", "thick", "thin", "third", "thirsty", "thorough", "thorny", "thoughtful", "threadbare", "thrifty", "thunderous", "tidy", "tight", "timely", "tinted", "tiny", "tired", "torn", "total", "tough", "traumatic", "treasured", "tremendous", "tragic", "trained", "tremendous", "triangular", "tricky", "trifling", "trim", "trivial", "troubled", "true", "trusting", "trustworthy", "trusty", "truthful", "tubby", "turbulent", "twin", "ugly", "ultimate", "unacceptable", "unaware", "uncomfortable", "uncommon", "unconscious", "understated", "unequaled", "uneven", "unfinished", "unfit", "unfolded", "unfortunate", "unhappy", "unhealthy", "uniform", "unimportant", "unique", "united", "unkempt", "unknown", "unlawful", "unlined", "unlucky", "unnatural", "unpleasant", "unrealistic", "unripe", "unruly", "unselfish", "unsightly", "unsteady", "unsung", "untidy", "untimely", "untried", "untrue", "unused", "unusual", "unwelcome", "unwieldy", "unwilling", "unwitting", "unwritten", "upbeat", "upright", "upset", "urban", "usable", "used", "useful", "useless", "utilized", "utter", "vacant", "vague", "vain", "valid", "valuable", "vapid", "variable", "vast", "velvety", "venerated", "vengeful", "verifiable", "vibrant", "vicious", "victorious", "vigilant", "vigorous", "villainous", "violet", "violent", "virtual", "virtuous", "visible", "vital", "vivacious", "vivid", "voluminous", "wan", "warlike", "warm", "warmhearted", "warped", "wary", "wasteful", "watchful", "waterlogged", "watery", "wavy", "wealthy", "weak", "weary", "webbed", "wee", "weekly", "weepy", "weighty", "weird", "welcome", "well-documented", "well-groomed", "well-informed", "well-lit", "well-made", "well-off", "well-to-do", "well-worn", "wet", "which", "whimsical", "whirlwind", "whispered", "white", "whole", "whopping", "wicked", "wide", "wide-eyed", "wiggly", "wild", "willing", "wilted", "winding", "windy", "winged", "wiry", "wise", "witty", "wobbly", "woeful", "wonderful", "wooden", "woozy", "wordy", "worldly", "worn", "worried", "worrisome", "worse", "worst", "worthless", "worthwhile", "worthy", "wrathful", "wretched", "writhing", "wrong", "wry", "yawning", "young", "youthful", "yummy", "zany", "zealous", "zesty", "zigzag"
]
