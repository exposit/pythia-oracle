...
def whatDidItDo():
    ...
    awareChart = [ "don't realize at first that something's happened", "don't notice anything amiss", "know immediately that something's wrong", "feel strange", "suffer a vision", "know immediately the effects", "know the effects and the ramifications", "know one of the effects immediately but not the other (if there's only one effect, push this button again and take all the results from that too)", "are protected from any consequences as long as you maintain the rules of the people who created the effect", "won't be affected until you wake up from your next sleep or see your next sunrise", "won't be affected until you next commit an act related to the effect", "won't be affected until you commit a sin", "will pass the effect to the next person you touch, curing you", "are contagious like a disease; people you touch must save or contract the effect(s) as well", "start convulsing as multiple magical effects take effect (use this generator 1d6+1 more times and take all the results from those rolls too)", "are knocked unconscious", "know that it's not all bad (use this generator until you get at least one positive effect and combine with your original one)", "are given a chance to change your fate (use this generator once more, then pick which of the results you like best)", "are caught at the epicenter of a magical vortex (get an effect for each person in the room and 1d6+1 effects for yourself)", "suffer the same fate as your comrades (everyone present shares the same effect you do)" ]
