...
def getPlotWeb(button, *args):
    ...
    conList = ['is sleeping with', 'is romancing', 'is seducing', 'is pursuing', 'is hunting', 'is working for', 'is conning', 'is bloodsworn to', 'is mortal enemies with', 'is rivals with', 'is afraid of', 'hates', 'loathes', 'loves', 'doesn\'t know of', 'knows a terrible secret about', 'is hiding a secret from', 'is partners in perversion with', 'is drinking buddies with', 'was beaten over an imagined slight by', 'was discarded by', 'is using', 'is tricking', 'is a client of', 'is chasing after', 'is trying to ruin', 'owes money to', 'fears replacement by', 'is attempting to convert', "is looking for", "is slandering", "is spreading scurrilous rumors about", "is paranoid about", "is justifiably paranoid about", "is the next target of", "is business partners with", "is on a team with", "is in a club with", "is passingly familiar with"]
