...
def getPlotWeb(button, *args):
    ...
    subjList = ['mage', 'necromancer', 'sorcerer', 'wizard', 'diviner', 'seer', 'oracle', 'hunter', 'forester', 'poacher', 'ranger', 'outlaw', 'bandit', 'thief', 'rogue', 'burglar', 'jewel thief', 'assassin', 'thug', 'second story man', 'highwayman', 'grave robber', 'archaeologist', 'anatomist', 'doctor', 'scientist', 'academic', 'teacher', 'professor', 'sage', 'psychic', 'astrologer', 'vizier', 'chancellor', 'nobleman', 'gentleman', 'king', 'prince', 'queen', 'princess', 'gentlewoman', 'lady', 'knight', 'spirit', 'ghost', 'phantom', 'vampire', 'werewolf', 'monster', 'fighter', 'warrior', 'soldier', 'demon hunter', 'wanderer', 'traveler', 'maiden', 'lad', 'merchant', 'shopkeeper', 'innkeeper', 'traitor', 'hermit', 'warlord', 'sorceress', 'shaman', 'healer', 'priest', 'acolyte', 'monk', 'baron', 'duke', 'serf', 'peasant', 'bartender', 'harlot', 'spy', 'adventurer', 'cleric', 'bard', 'entertainer', 'dancer', 'singer', 'musician', 'actor', 'actress', 'playwright', 'blacksmith', 'tinker', 'barbarian', 'alchemist', 'crafter', 'artisan', 'artist', 'butler', 'servant', 'enforcer', 'mercenary', 'pilgrim', 'arcane dabbler', 'mystic', 'beast tamer', 'youth', 'maid', 'virgin', 'naive innocent', 'libertine', 'rake', 'innocent victim of a curse', 'deserving victim of a curse', 'criminal', 'escapee', 'archer', 'madman', 'deserter', 'renegade', 'outcast', 'demon', 'devil']

    conList = ['is sleeping with', 'is romancing', 'is seducing', 'is pursuing', 'is hunting', 'is working for', 'is conning', 'is bloodsworn to', 'is mortal enemies with', 'is rivals with', 'is afraid of', 'hates', 'loathes', 'loves', 'doesn\'t know of', 'knows a terrible secret about', 'is hiding a secret from', 'is partners in perversion with', 'is drinking buddies with', 'was beaten over an imagined slight by', 'was discarded by', 'is using', 'is tricking', 'is a client of', 'is chasing after', 'is trying to ruin', 'owes money to', 'fears replacement by', 'is attempting to convert', "is looking for", "is maliciously slandering", "is spreading scurrilous rumors about", "is paranoid about", "is justifiably paranoid about", "is the next target of", "is business partners with", "is on a team with", "is in a club with", "is passingly familiar with", "wants to ruin", "is partners with", "pretends to love", "pretends to respect", "pretends to dislike", "quarrels with", "has an on-again, off-again romance with", "has a passion for", "has a passionate relationship with", "is secretly seeing", "is secretly working with", "is  secretly working against", "is a secret admirer of", "has an unrequited love for", "is beneath the notice of", "is held in contempt by", "is mocked regularly by", "was bested by", "badly injured", "was nearly killed by", "was nearly killed over", "has lost interest in", "is bored with", "is toying with", "was insulted and humiliated by", "wants to impress", "wants the approval of", "wants the love of", "wants the forgiveness of", "wants the understanding of", "wants the respect of", "opposes every goal of", "is married to or devoted to", "is close blood kin of", "is distant blood kin of", "hates but can't escape from", "is in love with", "is trying to ruin", "was childhood friends with", "grew up with", "was childhood rivals with", "came to blows with", "respects the opinion of", "disregards the value of", "finds everything objectionable about", "finds everything admirable about", "seeks out the advice of", "is a friend of", "is married to", "is trapped by", "wants to free", "puts up with", "watches out for", "was saved from harm by", "was saved from dire peril by", "was saved from embarrassment or social ruin by", "took a blow for", "sacrificed everything for", "is loyal to", "is disloyal to", "is an ex of", "was close to but is now estranged from", "is resentful of", "is afraid of", "is afraid for"]
